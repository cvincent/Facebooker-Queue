...
FacebookerQueue is an easy way to background your Facebooker API calls.
...
Copyright (c) 2009 "Chris Vincent":http://code.isdangero.us/, released under the MIT license
